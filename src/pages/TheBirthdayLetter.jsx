        ...
        <div className="app">
            <div className="paper">
                <div className="letter">
                    ...
                    <p>
                        sejak pertama kali kamu hadir, banyak hal yang berubah tanpa aku sadari, dan dirayakan sebagai seseorang yang pantas dicintai, aku selalu merasa cukup bahkan lebih dari cukup ketika kamu ada. caramu memahami aku tanpa aku perlu menjelaskan apa apa.
                    </p>
                    <p>
                        apa yang membuatku cocok denganmu? 
kamu tuh baik, cantik, lucu, menggemaskan, perhatian, teruusss kenyamanan yang selama ini aku cari cari, kamu juga seseorang yang aku butuhkan, teman cerita, temen mabar, dan rumah bagiku yang sering merasa lelah, terima kasih sayang
                    </p>
                    <p style={{ textAlign: "right" }}>with love, Miki</p>
                </div>
            </div>
